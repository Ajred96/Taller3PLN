...
# ==========================================
# 4. CONFIGURACIÓN DEL ENTRENAMIENTO (CORREGIDO)
# ==========================================
# 1. Cargamos el modelo 
model = AutoModelForSequenceClassification.from_pretrained(MODEL_NAME, num_labels=2)

# 2. Argumentos del Experimento 1 (Batch Size = 8)
training_args = TrainingArguments(
    output_dir="./outputs/modelBetoSarcasmo/results_beto_bs8", # Ajustado a tu ruta local de outputs
    eval_strategy="epoch",
    save_strategy="epoch",
    learning_rate=1e-5,
...
# 3. Inicializamos el Trainer con la paciencia corregida a 2
trainer = Trainer(
    model=model,
    args=training_args,
...
if __name__ == "__main__":
    print("\n=== Iniciando el entrenamiento de BETO (Batch Size = 8) ===")
    # trainer.train() 